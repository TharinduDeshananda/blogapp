...
function TopBar() {
  ...
  return (
    <div className="h-[60px] border-b flex flex-row items-center sticky left-0 top-0  z-50 bg-gray-900">
      <div className="absolute left-3 md:hidden">Menu Button</div>
      <div className="flex-[3] flex justify-center items-center overflow-hidden text-white">
            ...
            <ContextMenu
              ...
              wrapperItem={
                <Avatar
                  ...
                  wrapperStyle="cursor-pointer self-center
                "
                />
              }
            >
